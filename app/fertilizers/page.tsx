...
export default function FertilizersPage() {
  ...
  // Filter logic handled client-side for price ranges
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="container px-4 pt-4 md:px-6">
        <PageHero
          title="Fertilizers & Growth Promoters"
          description="Boost your Arecanut plantation's yield with our premium range of fertilizers and growth enhancers."
          imageSrc="/fertilizer-hero.jpg"
          ...
          {!loading && products.length === 0 && (
            <div className="col-span-full text-center py-12">
              <p className="text-muted-foreground">
                No fertilizers found matching your criteria
              </p>
            </div>
          )}
